	...
	<body style="background-image: url(../res/otherback.jpg); background-size: cover;">
		...
		<div class="container" style="text-align: center;">
			...
			<%
				...
				ResultSet getEventsRSET = getEventsSTAT.executeQuery("select e.topic, e.event_date, e.start_time, e.end_time, e.booked_on, c.name, e.venue from event e, contact c where e.id wing = '" + request.getParameter("wing") + "' and e.id = c.event_id and c.role = 'Booker' and e.event_date>now() and e.status in (2, 4)");
				getEventsRSET.last();
