	...
	<body style="background-image: url(../res/otherback.jpg); background-size: cover;">
		...
		<div class="container" style="text-align: center; min-width: 100%;">
			...
			<%
			 ...
			 getClassEventsRSET = getClassEventsSTAT.executeQuery("select id, topic_name, event_date,start_time,end_time, booked_on, booker_name,venue from class_events where  status in(1,2,3,6) and event_date > now()");
...
<form name="event" id="event" action="cancellation.jsp" method="post" autocomplete="off">
