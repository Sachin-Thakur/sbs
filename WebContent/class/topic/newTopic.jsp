			...
			<div class="panel panel-default" style="background-color: rgba(55, 55, 55, .80); border: 0px; padding: 15px; border-bottom-right-radius: 15px; border-bottom-left-radius: 15px; border-top-right-radius: 0px; border-top-left-radius: 0px; text-align: center; overflow: auto;">
				<form class="form-inline" action="addTopic.jsp" method="post" style="margin-left: auto; margin-right: auto; text-align: center;">
					...
					<div class="form-group" style="margin-left: auto; margin-right: auto; border-bottom-color: #cc982d; border-bottom: 2px;">
						...
						<input type="text" name="topicName" class="form-control" style="margin-top: 15px; margin-right: 15px; background-color: rgba(0, 0, 0, 0); color: #aaa;" placeholder="Enter Topic" required></input>
						
						<input type="number"  max = "8"  name="topicDuration" class="form-control" style="margin-top: 15px; margin-right: 15px; background-color: rgba(0, 0, 0, 0); color: #aaa;" placeholder="Enter Duration " ></input>
		
						<input type="text"  name="topicDetails" class="form-control" style="margin-top: 15px; margin-right: 15px; background-color: rgba(0, 0, 0, 0); color: #aaa;" placeholder="Enter Recommendations " ></input>
					...
					<div class="form-group" style="margin-left: auto; margin-right: 15px;">
						<input class="btn btn-success" name="submitButton" type="submit" value="Add Topic" style="background-color: #223260; color: #cc982d; border: 0px;">
					</div>
				</form>
			</div>
		</div>
