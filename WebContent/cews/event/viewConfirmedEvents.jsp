...
<%try{ %>
			<%
			 ...
			 getEventsRSET = getEventsSTAT.executeQuery("select topic_name, event_date, start_time, end_time, booked_on, booker_name, venue from class_events where status = 'confirmed' ");
			 getEventsRSET.last();
