		...
		<div class="container" style="text-align: center;">
			...
			<table class="table table-bordered" style="white-space: nowrap;">
				...
				while(getEventsRSET.next()){
					...
					String stat = str.equals("cancelled")?"Session Cancelled":str.equals("confirmed")?"Session Confirmed":str.equals("pending")?"Session Pending Approval":str.equals("rejected")?"Rejected By the Admin":"Session Completed";
